    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, maxWidth: 760 }}>
      ...
      <Glass padding={20} radius={22} style={{ overflow: 'visible', zIndex: 2 }}>
        ...
        <div style={{ color: btb.textMuted, fontSize: 12, marginBottom: 14 }}>
          Pick two tokens on {chainName}. We check Uniswap V3{v4DeploymentFor(chainId) ? ', Uniswap V4' : ''}{v3DeploymentFor('pancakeswap', chainId) ? ', PancakeSwap V3' : ''}{chainId === 8453 ? ', Aerodrome Slipstream' : ''}{chainId === 4663 ? ', Giga V3, Ramses V3, UP' : ''}, and the wider DEX market together.
        </div>
