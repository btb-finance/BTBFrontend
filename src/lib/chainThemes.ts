...
export function chainThemeCss(theme: ChainTheme, mode: ColorMode = 'dark'): Record<string, string> {
  ...
  if (mode === 'light') {
    return {
      ...
      '--chain-surface': 'rgba(11,15,14,.045)',
      '--chain-surface-strong': 'rgba(11,15,14,.075)',
      '--chain-surface-soft': 'rgba(11,15,14,.03)',
      '--chain-border': '1px solid rgba(11,15,14,.12)',
      '--chain-border-soft': '1px solid rgba(11,15,14,.07)',
      '--chain-shadow': '0 8px 28px rgba(20,40,34,.10), 0 1px 0 rgba(255,255,255,.6) inset',
      '--chain-gradient': 'linear-gradient(135deg, #0B0F0E, #2C3A37)',
      '--chain-app-background': 'radial-gradient(900px 600px at 8% -10%, rgba(29,233,182,.14), transparent 60%), radial-gradient(800px 600px at 100% 0%, rgba(19,191,148,.10), transparent 60%), #F9FBFA',
    };
  }
  return {
    '--color-mode': 'dark',
    ...
    '--chain-bg': '#0B0F0E',
    '--btb-text': '#FFFFFF',
    '--btb-text-muted': '#A8BDB8',
    '--btb-text-dim': '#6F938A',
    '--btb-green': '#1DE9B6',
    '--green-rgb': '29, 233, 182',
    '--btb-amber': '#FDB022',
    '--amber-rgb': '253, 176, 34',
    '--btb-loss': '#F04438',
    '--loss-rgb': '240, 68, 56',
    '--chain-accent': theme.accent,
    '--chain-accent-2': theme.accent2,
