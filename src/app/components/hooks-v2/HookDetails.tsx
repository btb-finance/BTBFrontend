    ...
    <div className="min-h-screen bg-gray-900 p-8">
      ...
      <div className="bg-gray-800 rounded-lg p-6 text-gray-300">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-2xl font-bold text-white">{hook.name || hook.address}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <div>
              ...
              <button onClick={() => copyToClipboard(hook.deployerAddress)} className="text-gray-400 hover:text-gray-200">
                  {copiedAddress ? <Check className="w-4 h-4" /> : <Copy className="w-4 h-4" />}
                </button>
            </div>
