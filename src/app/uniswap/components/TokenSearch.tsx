...
export const TokenSearch: React.FC<TokenSearchProps> = ({ onSelectToken, isLoading, selectedToken }) => {
      ...
      <h2 className="text-xl font-bold mb-4">
        {selectedToken ? (
          <div className="flex items-center justify-between">
            <span>Selected: {selectedToken.symbol || selectedToken.address.substring(0, 8)}</span>
            <Button 
              variant="ghost" 
              size="sm" 
