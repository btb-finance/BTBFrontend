...
export const styles: Record<string, CSSProperties> = {
  ...
  eyebrow: { color: '#FFA24A', fontSize: 12, fontWeight: 700, letterSpacing: 0.8, textTransform: 'uppercase', margin: '0 0 10px' },
  ...
  ctaPrimary: { display: 'inline-flex', alignItems: 'center', height: 44, padding: '0 20px', borderRadius: 12, background: 'linear-gradient(135deg,#FFA24A,#F07A1A)', color: '#fff', fontWeight: 700, fontSize: 14, textDecoration: 'none' },
  ...
  tdStrong: { padding: '12px 14px', borderBottom: '1px solid rgba(255,255,255,0.06)', color: '#FFA24A', fontWeight: 700, verticalAlign: 'top' },
};
