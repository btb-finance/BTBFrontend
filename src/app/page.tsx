...
const products = [
  ...
  {
    name: 'BTB Finance Revolution',
    description: 'Revolutionary arbitrage-powered ecosystem! Deposit ETH → Mint BTB → Create price gaps → Arbitragers capture 0.1% fees → 0.05% burns supply → 0.05% rewards LPs → Infinite upward loops!',
    detailedDescription: 'BTB Finance is a breakthrough protocol where users deposit ETH to mint BTB tokens. We provide BTB/USDC liquidity on Aerodrome/Uniswap, creating price differences. Arbitragers capture these gaps paying 0.1% fees: 0.05% burns BTB supply forever, 0.05% rewards LP providers. Want BTB upside without holding ETH? Deposit ETH, get BTB, then borrow your ETH back - pure BTB exposure with all profits!',
    features: ['ETH deposit minting', 'Arbitrage fee capture', 'Dual-sided LP rewards', 'ETH borrowing against BTB'],
...
export default function Home() {
  ...
  return (
    <div className="relative isolate">
      ...
      {/* BTB Finance Revolution Section */}
      <div className="py-16 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 relative overflow-hidden">
        {/* Background elements */}
        <div className="absolute inset-0 overflow-hidden opacity-10 pointer-events-none">
          <div className="absolute top-0 right-0 w-full h-64 bg-gradient-to-l from-blue-400 to-indigo-500 skew-y-6 transform -translate-y-24"></div>
          <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-r from-blue-400 to-indigo-500 skew-y-6 transform translate-y-24"></div>
        </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-5xl font-bold mb-6">
                <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                  BTB Finance Revolution
                </span>
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                The most sophisticated arbitrage-powered tokenomics system in DeFi. Every trade creates value, burns supply, and rewards participants.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-16">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">🔄 The Arbitrage Loop Engine</h3>
                
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white mr-4 font-bold">
                      1
                    </div>
                    <div>
                      <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-2">ETH Deposit → BTB Minting</h4>
                      <p className="text-gray-600 dark:text-gray-300">
                        Users deposit ETH → Protocol mints fresh BTB tokens → Creates the foundation for arbitrage opportunities
                      </p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-full bg-gradient-to-r from-indigo-500 to-indigo-600 text-white mr-4 font-bold">
                      2
                    </div>
                    <div>
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-full bg-gradient-to-r from-purple-500 to-purple-600 text-white mr-4 font-bold">
                      3
                    </div>
                    <div>
                      <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Arbitrage Fee Capture</h4>
                      <p className="text-gray-600 dark:text-gray-300">
                        Price gaps emerge → Arbitragers trade → Pay <strong>0.1% fees</strong> → Revenue split into two powerful mechanisms
                      </p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-full bg-gradient-to-r from-pink-500 to-pink-600 text-white mr-4 font-bold">
                      4
                    </div>
                    <div>
                      <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Dual Reward Distribution</h4>
                      <p className="text-gray-600 dark:text-gray-300">
                        <strong>0.05%</strong> burns BTB supply forever (deflationary pressure) + <strong>0.05%</strong> rewards LP providers (sustainable yield)
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-8 border border-blue-200 dark:border-blue-800">
                  <div className="text-center mb-6">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">💎 Pure BTB Exposure Strategy</h3>
                    <p className="text-gray-600 dark:text-gray-400">Get all BTB upside without holding ETH</p>
                  </div>
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-blue-100 dark:border-blue-700">
                      <div className="flex items-center mb-2">
                        ...
                        <h4 className="font-bold text-gray-900 dark:text-white">Step 1: Deposit ETH</h4>
                      </div>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Deposit your ETH → Receive BTB tokens</p>
                    </div>
                    
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-indigo-100 dark:border-indigo-700">
                      <div className="flex items-center mb-2">
                        <span className="text-2xl mr-3">💰</span>
                        <h4 className="font-bold text-gray-900 dark:text-white">Step 2: Borrow ETH Back</h4>
                      </div>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Use BTB as collateral → Borrow your ETH back</p>
                    </div>
                    
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-purple-100 dark:border-purple-700">
                      <div className="flex items-center mb-2">
                        <span className="text-2xl mr-3">🚀</span>
                        <h4 className="font-bold text-gray-900 dark:text-white">Result: Pure BTB Gains</h4>
                      </div>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Keep ETH + Get all BTB price appreciation!</p>
                    </div>
                  </div>
                  
                  <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-4 rounded-lg text-center">
                    <div className="font-bold mb-1">🎯 Ultimate Win-Win</div>
                    <p className="text-sm opacity-90">Zero ETH exposure risk + Maximum BTB upside</p>
                  </div>
                </div>
              </motion.div>
            </div>
            
            {/* Arbitrage Economics Breakdown */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              ...
              className="mb-16"
            >
              <h3 className="text-2xl font-bold text-center text-gray-900 dark:text-white mb-8">⚡ Arbitrage Economics Breakdown</h3>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-indigo-200 dark:border-indigo-800 shadow-lg">
                  <div className="text-4xl mb-4">💎</div>
                  <h4 className="font-bold text-gray-900 dark:text-white mb-2">Arbitrage Fees</h4>
                  <p className="text-indigo-600 dark:text-indigo-400 text-lg font-bold">0.1%</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Every arbitrage trade</p>
                </div>
                
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-red-200 dark:border-red-800 shadow-lg">
                  <div className="text-4xl mb-4">🔥</div>
                  <h4 className="font-bold text-gray-900 dark:text-white mb-2">Supply Burns</h4>
                  <p className="text-red-600 dark:text-red-400 text-lg font-bold">0.05%</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Permanent deflation</p>
                </div>
                
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center border border-emerald-200 dark:border-emerald-800 shadow-lg">
                  <div className="text-4xl mb-4">🏆</div>
                  <h4 className="font-bold text-gray-900 dark:text-white mb-2">LP Rewards</h4>
                  <p className="text-emerald-600 dark:text-emerald-400 text-lg font-bold">0.05%</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Sustainable yield</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-2xl p-8 text-white text-center"
            >
              <h3 className="text-3xl font-bold mb-6">🔄 The Infinite Upward Loop</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white/10 rounded-lg p-4">
                  <h4 className="font-bold mb-2">More Users Join</h4>
                  <p className="text-sm opacity-90">ETH deposits → BTB minting → More liquidity</p>
                </div>
                <div className="bg-white/10 rounded-lg p-4">
                  <h4 className="font-bold mb-2">More Arbitrage</h4>
                  <p className="text-sm opacity-90">Price gaps → More trades → More fees collected</p>
                </div>
                <div className="bg-white/10 rounded-lg p-4">
                  <h4 className="font-bold mb-2">Stronger Economics</h4>
                  <p className="text-sm opacity-90">More burns → Higher yields → Better prices</p>
                </div>
              </div>
              <p className="text-xl font-bold">🚀 Result: Every trade makes BTB more valuable while rewarding all participants!</p>
            </motion.div>
          </div>
        </div>
      </div>
